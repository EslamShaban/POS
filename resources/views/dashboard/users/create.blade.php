            ...
            <form action="{{route('dashboard.users.store')}}" method="POST" enctype="multipart/form-data">
                ...
                {{ method_field('post') }}
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="first_name" name="f_name" value="{{old('f_name')}}">
                    </div>
                    <div class="form-group">
                        <label for="lname">@lang('site.last_name')</label>
                        <input type="text" class="form-control" id="last_name" name="l_name" value="{{old('l_name')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="pass">@lang('site.password')</label>
                        <input type="password" name="password" class="form-control" id="pass" >
                    </div>
                    <div class="form-group">
                        <label for="passConfirm">@lang('site.confirmpassword')</label>
                    ...
                    <div class="form-group">
                        <img src="{{asset('uploads/users_image/default.png')}}" class="imgPreview img-thumbnail" style="width:100px" alt="" >
                    </div>
                                ...
                                @foreach ($models as $index=>$model)
                                  ...
                                  <div class="tab-pane {{$index == 0 ? 'active' : ''}}" id="{{$model}}">
                                      @foreach ($permissions as $perm)
                                        ...
                                        <label><input type="checkbox" name="permissions[]" value="{{$perm  . '-' . $model}}"> @lang('site.' . $perm)</label> 
